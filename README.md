...
4. If you haven't downloaded any filters yourself, run the `node download_lists.js` command to download recommended filter lists (HaGeZi Pro and AdAway; about 170,000 blocked domains after processing).
